...
func (g *Galleries) Create(w http.ResponseWriter, r *http.Request) {
	...
	// create a URL using the router and the named ShowGallery route
...
func (g *Galleries) Show(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		// the galleryByID method already render the error for us.
		return
	}
...
// GET /galleries/:id/edit. render form
...
// POST /galleries/:id/update. parse/process form
